...
const CartListItem = ({id, productName, productPrice, productImg, productNumber, sizes, types}) => {
    ...
    <li className="cart__list-item">
      ...
      <div className="cart__list-item__main">
        <div className="cart__list-item-descr">
          ...
          <h2 className="cart__list-item-params">{types[types.findIndex((type) => type.default === true)].typeName} {sizes[sizes.findIndex((size) => size.default === true)].sizeValue} см</h2>
        </div>
